...
const periodicTable = [
  '/Subjects/Chemistry/Periodic_Table/periodictable.html',
  'Interactive Periodic Table',
  'Learn more about elements in a fun hands-on experience!',
];
const bonds = [
  '/Subjects/Chemistry/Bonds/Bonds.html',
  'Bonds',
  'Explore how elements stick together!',
];
const atoms = [
  '/Subjects/Chemistry/Atoms/atoms.html',
  'Atoms',
  'Explore the tiny molecules that make up your world!',
];
...
async function appendTopic(array, index) {
  ...
  if (array[index] != undefined) {
    ...
    const recommendedTopics =
      '<a href=' +
      recTopic[0] +
      `><subtopic${index + 1}><span></span><span2></span2><h2>` +
      recTopic[1] +
      '</h2><p>' +
      recTopic[2] +
      `</p></subtopic${index + 1}></a>`;
...
let noRecsHTML =
  "<h2>No Recommendations!</h2> There are no subtopics recommended for you at the moment. You're all caught up! <br /> Attempt some more subtopic quizzes to get more recommendations.";
let noRecs = document.getElementById('empty');
let recTag = document.querySelector('.subtopic');

if (recTag.innerHTML === '') {
  noRecs.classList.add('textbox');
  noRecs.innerHTML += noRecsHTML;
}
